        ...
        <ul class="nav flex-column px-3 pt-3">
            ...
            <li class="nav-item mb-2">
                <a href="<?= base_url('admin/references') ?>"
                    class="nav-link <?= $uri->getSegment(2) === 'references' ? 'active fw-bold text-primary' : 'text-dark' ?>">
                    References
                </a>
            </li>
            <!-- Upload Article XML -->
            <li class="nav-item mb-2">
                <a href="<?= base_url('admin/upload-article-xml') ?>"
                    class="nav-link <?= uri_string() === 'admin/upload-article-xml' ? 'active fw-bold text-primary' : 'text-dark' ?>">
                    Upload Article XML
                </a>
            </li>
            <!-- Logout -->

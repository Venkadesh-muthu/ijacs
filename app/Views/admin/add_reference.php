<main class="main-content">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="fw-bold">Add Reference</h2>
        ...
        <form action="<?= base_url('admin/references/add') ?>" method="post" class="card shadow-sm p-4">
            <?= csrf_field() ?>
            ...
            <div class="row mb-3">
                <div class="col-md-2">
                    ...
                    <input type="number" name="ref_no" id="ref_no" class="form-control" value="<?= old('ref_no') ?>">
                </div>
                <div class="col-md-10">
                    <label for="authors" class="form-label fw-semibold">Authors *</label>
                    <input type="text" name="authors" id="authors" class="form-control" value="<?= old('authors') ?>"
            ...
            <div class="mb-3">
                <label for="source" class="form-label fw-semibold">Source (Journal / Book Title) *</label>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-2">
                    ...
                    <input type="text" name="issue" id="issue" class="form-control" value="<?= old('issue') ?>">
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="pages" id="pages" class="form-control" value="<?= old('pages') ?>"
                        placeholder="e.g., 123–129">
                </div>
                <div class="col-md-6">
            ...
            <div class="text-end mt-4">
                <button type="submit" class="btn btn-primary">
                    <i class="bi bi-save me-1"></i> Save Reference
                </button>
            </div>
        </form>
    </div>
